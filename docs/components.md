...
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- | ----------------------- |
| Core explore   | `/home`, `/hot`, `/search`, `/collections`, `/resources`                                                                                                                           | `isCoreExploreRoute`   | `isCoreExploreRoute`    |
| Dynamic public | `/post/[userId]/[postId]`, `/profile/[pubky]`, `/invite/[code]`, `/collections/[userId]/[postId]`, `/resources/[32-lowercase-hex-id]`, `/resources/lookup`, `/resources/tag/[tag]` | `isDynamicPublicRoute` | `isDynamicPublicRoute`  |
