# ADR 0024: Vibe Session Consumer
...
- Distinct from: [ADR 0017 runtime-config injection](./0017-runtime-config-injection.md) and [ADR 0018 runtime Sentry](./0018-runtime-sentry-and-decoupled-source-maps.md). Numbered 0024 on this marketplace branch because 0019–0023 were already taken.
