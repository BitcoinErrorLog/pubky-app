...
Canonical `pubky.app` leaves both unset. The first client pass always strips `#s=` from the URL, even when consumer mode is off. See [ADR 0024](adr/0024-vibe-session-consumer.md).
