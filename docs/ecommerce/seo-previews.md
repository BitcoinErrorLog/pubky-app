...
| Auth-gated pages (orders, offers, messages, dashboard, my-shop, sell, cart, notifications, moderation, settings, listing edit) | Static generic copy via `gatedMarketplaceMetadata`, `noindex, nofollow`, zero user data                                                                                    | The `/marketplace` branded card, referenced explicitly (Next file-convention images do not cascade to nested routes)     |
