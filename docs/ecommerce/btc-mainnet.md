...
- **The address is persisted next to the identity, and the arm routes by the
  ...
  a seller confirming in the tail of their 24 h window, or an a seller resolving
