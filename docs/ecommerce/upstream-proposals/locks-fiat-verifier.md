...
lives in the verifier service. A per-processor wire value would be a *claim the Lock
Server cannot check*, which is worse than a generic one it can (namely: "my configured
