 ...
 * opaque aggregate reference, and a timestamp. Order contents, payment
 * detail, delivery info, and message bodies never reach this shape because
 * the fields simply do not exist on it.
 */
