...
export class CommerceApplication {
   ...
   */
  static beginPaykitClaimFlow(actorPubky: string, accountXpub: string, accountIndex: number) {
    return MarketplacePaykitClaimService.beginClaimFlow(actorPubky, accountXpub, accountIndex);
  }
