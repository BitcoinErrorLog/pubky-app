        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <Typography as="p" className="mt-2 max-w-xl text-muted-foreground">
              Reusable templates for the sell studio&apos;s shipping fields (label, flat price, delivery estimate).
              Stored on this device only — applying one just pre-fills the form, and listings publish exactly as before.
            </Typography>
          </div>
          {editingId === null && (
