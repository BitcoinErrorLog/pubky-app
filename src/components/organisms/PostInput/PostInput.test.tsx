...
function createUsePostInputReturn(options: UsePostInputOptions, overrides: Record<string, unknown> = {}) {
  return {
    ...
    mentionDisplay: mockUsePostReturn.content,
    mentionTokens: {
      display: mockUsePostReturn.content,
      handleChange: vi.fn(),
      addMention: vi.fn(),
      addMentionForQuery: vi.fn(),
      handleBackspace: vi.fn(() => false),
      handlePaste: vi.fn(async () => false),
      resetDisplay: vi.fn(),
    },
