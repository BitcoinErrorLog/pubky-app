 ...
 * type, an actor and a post kind, or a marketplace notification interleaved by
 * timestamp. Grouped runs hold at least MIN_NOTIFICATION_GROUP_SIZE members, newest
 * first (mirroring the source order).
 */
