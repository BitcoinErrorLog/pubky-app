...
export const runtimeEnvInputSchema = z
  .object({
    ...
    pubkyRingUrl: optionalTrimmedString,
    pubkyCoreUrl: optionalTrimmedString,
    nexusScoutUrl: optionalTrimmedString,
    twitterUrl: optionalTrimmedString,
    twitterGetpubkyUrl: optionalTrimmedString,
    telegramUrl: optionalTrimmedString,
    githubUrl: optionalTrimmedString,
    email: optionalTrimmedString,
    appStoreUrl: optionalTrimmedString,
    playStoreUrl: optionalTrimmedString,
  })
